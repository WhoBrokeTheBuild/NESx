...
// void _DebugMemoryRegionChanged(GtkComboBox * cmb, NESxDebugger * win)
// {
...
// void _DebugSetMemoryRegions(NESxDebugger * win, mem_region_select_t * regions)
// {
...
void _DebugUpdateStatus(NESxDebugger * win)
{
    char buffer[32];

    snprintf(buffer, sizeof(buffer), "%lu", win->cpu->Cycles);
    gtk_label_set_text(win->lblCPUCycle, buffer);
...
void _DebugUpdateRegisters(NESxDebugger * win)
{
    char buffer[5];
...
void _DebugUpdateStatusRegisters(NESxDebugger * win)
{
...
void _DebugUpdateCPUInternals(NESxDebugger * win)
{
    char buffer[5];
...
void _DebugUpdate(NESxDebugger * win)
{
...
void _DebugTick(GtkButton * btn, NESxDebugger * win)
{
    NESx_Tick(win->nes);
    _DebugUpdate(win);
}

void _DebugStep(GtkButton * btn, NESxDebugger * win)
{
    NESx_Step(win->nes);
    _DebugUpdate(win);
}

// void _DebugRun(GtkButton * btn, NESxDebugger * win)
// {
//     win->running = true;
// }

// void _DebugStop(GtkButton * btn, NESxDebugger * win)
// {
//     win->running = false;
// }

// void _DebugDestroy(GtkWindow * window, NESxDebugger * win)
// {
...
void nesx_debugger_class_init(NESxDebuggerClass * klass)
{
    ...
    // Controls
    gtk_widget_class_bind_template_child(wc, NESxDebugger, btnRun);
    gtk_widget_class_bind_template_child(wc, NESxDebugger, btnStop);
    gtk_widget_class_bind_template_child(wc, NESxDebugger, btnTick);
    gtk_widget_class_bind_template_child(wc, NESxDebugger, btnStep);
    // gtk_widget_class_bind_template_child(wc, NESxDebugger, btnFrame);
